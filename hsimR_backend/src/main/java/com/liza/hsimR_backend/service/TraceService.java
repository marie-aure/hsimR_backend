...
public interface TraceService {
	...
	void tracer(TraceType type, Principal principal, String description) throws EntityNotFoundException;

	void tracer(TraceType type, Franchise franchise, String description);
