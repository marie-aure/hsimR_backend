...
public class BanqueController {
	...
	public List<TransactionDto> historiqueTransaction(Principal principal, @PathVariable(name = "type") String type) {
		try {
			return banqueService.historiqueTransaction(principal, type);
		} catch (EntityNotFoundException e) {
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, e.getMessage());
		}
	}
